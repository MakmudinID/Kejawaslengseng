    ...
    <div class="container container-full">
        <div class="page-inner">
            ...
            <div class="row row-projects">
                <?php if ($listPesananLuar != null) : ?>
                    <div class="card-columns">
                        <?php $i = 1;
                        foreach ($listPesananLuar as $rp) : ?>
                            <div class="card">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="btn-group dropdown" style="height:100%; width:100%;">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>
                                                        <a class="dropdown-item" href="<?= base_url('dapur/proses_pesananluar/' . $rp['id']); ?>">Proses Pesanan</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href="<?= base_url('dapur/batalkan_pesananluar/' . $rp['id']); ?>">Batalkan Pesanan</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
